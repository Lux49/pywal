...
def adjust(colors, light):
    ...
    if light:
        ...
        ---raw_colors[7] = util.saturate_color(colors[7], darken)
        raw_colors[8] = util.saturate_color(colors[13], darken)
        raw_colors[9] = util.saturate_color(raw_colors[1], darken)
        raw_colors[10] = util.saturate_color(raw_colors[2], darken)
        raw_colors[11] = util.saturate_color(raw_colors[3], darken)
        raw_colors[12] = util.saturate_color(raw_colors[4], darken)
        raw_colors[13] = util.saturate_color(raw_colors[5], darken)
